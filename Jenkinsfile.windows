    ...
    stages {
        ...
        stage('Execute PowerShell Script') {
            steps {
                ...
                powershell """
                .\\jenkins-terraform.ps1 -Action ${params.TERRAFORM_ACTION} -ContainerName ${params.CONTAINER_NAME} -ExternalPort ${params.EXTERNAL_PORT} -ImageName ${params.IMAGE_NAME}
                """
            }
        }
    }
